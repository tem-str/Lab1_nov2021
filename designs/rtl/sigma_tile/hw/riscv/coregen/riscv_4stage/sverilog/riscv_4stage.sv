...
logic unsigned [0:0] gen181_pipex_succreq;
logic unsigned [31:0] gen182_pipex_succbuf;
...
logic unsigned [32:0] gen184_pipex_var;
...
logic unsigned [31:20] gen195_pipex_var;
...
logic unsigned [12:0] gen201_pipex_var;
logic unsigned [0:0] gen202_pipex_var;
logic unsigned [31:0] gen203_pipex_var;
logic unsigned [31:0] gen204_pipex_var;
logic unsigned [20:0] gen205_pipex_var;
...
logic unsigned [31:0] gen215_pipex_var;
...
logic unsigned [31:0] gen230_pipex_var [31:1];
...
logic unsigned [4:0] gen242_pipex_var;
...
logic unsigned [4:0] gen250_pipex_var;
...
logic unsigned [32:0] gen278_pipex_var;
...
logic unsigned [31:0] gen366_pipex_mcopipe_rdata;
genpstage_EXEC_TRX_BUF_STRUCT genpstage_EXEC_push_trx;
logic unsigned [31:0] gen367_pipex_mcopipe_rdata;
...
logic unsigned [31:0] gen316_cyclix_var [31:1];
...
always @*
	...
	gen366_pipex_mcopipe_rdata = 32'd0;
	...
	gen367_pipex_mcopipe_rdata = 32'd0;
	...
	gen368_pipex_req_struct = '{default:32'd0};
	...
	// Buffering globals
	gen316_cyclix_var[1] = genpsticky_glbl_regfile[1];
	gen316_cyclix_var[2] = genpsticky_glbl_regfile[2];
	gen316_cyclix_var[3] = genpsticky_glbl_regfile[3];
	gen316_cyclix_var[4] = genpsticky_glbl_regfile[4];
	gen316_cyclix_var[5] = genpsticky_glbl_regfile[5];
	gen316_cyclix_var[6] = genpsticky_glbl_regfile[6];
	gen316_cyclix_var[7] = genpsticky_glbl_regfile[7];
	gen316_cyclix_var[8] = genpsticky_glbl_regfile[8];
	gen316_cyclix_var[9] = genpsticky_glbl_regfile[9];
	gen316_cyclix_var[10] = genpsticky_glbl_regfile[10];
	gen316_cyclix_var[11] = genpsticky_glbl_regfile[11];
	gen316_cyclix_var[12] = genpsticky_glbl_regfile[12];
	gen316_cyclix_var[13] = genpsticky_glbl_regfile[13];
	gen316_cyclix_var[14] = genpsticky_glbl_regfile[14];
	gen316_cyclix_var[15] = genpsticky_glbl_regfile[15];
	gen316_cyclix_var[16] = genpsticky_glbl_regfile[16];
	gen316_cyclix_var[17] = genpsticky_glbl_regfile[17];
	gen316_cyclix_var[18] = genpsticky_glbl_regfile[18];
	gen316_cyclix_var[19] = genpsticky_glbl_regfile[19];
	gen316_cyclix_var[20] = genpsticky_glbl_regfile[20];
	gen316_cyclix_var[21] = genpsticky_glbl_regfile[21];
	gen316_cyclix_var[22] = genpsticky_glbl_regfile[22];
	gen316_cyclix_var[23] = genpsticky_glbl_regfile[23];
	gen316_cyclix_var[24] = genpsticky_glbl_regfile[24];
	gen316_cyclix_var[25] = genpsticky_glbl_regfile[25];
	gen316_cyclix_var[26] = genpsticky_glbl_regfile[26];
	gen316_cyclix_var[27] = genpsticky_glbl_regfile[27];
	gen316_cyclix_var[28] = genpsticky_glbl_regfile[28];
	gen316_cyclix_var[29] = genpsticky_glbl_regfile[29];
	gen316_cyclix_var[30] = genpsticky_glbl_regfile[30];
	gen316_cyclix_var[31] = genpsticky_glbl_regfile[31];
	// fifo_in buffering
	...
	gen0_rtl_var = gen204_cyclix_var;
	if (gen0_rtl_var)
		begin
		genpstage_MEMWB_genctrl_new = 32'd0;
		genpstage_MEMWB_genctrl_stalled_glbl = 32'd0;
	...
	if (gen2_rtl_var)
		...
		gen4_rtl_var = gen208_cyclix_var;
		if (gen4_rtl_var)
			begin
			gen209_cyclix_var = (genpstage_MEMWB_TRX_BUF[0].genmcopipe_handle_data_mem.if_id == 1'd0);
			gen210_cyclix_var = gen209_cyclix_var;
			gen5_rtl_var = gen210_cyclix_var;
			if (gen5_rtl_var)
				begin
				...
				gen6_rtl_var = gen212_cyclix_var;
				if (gen6_rtl_var)
					begin
					gen7_rtl_var = !rst_i;
					...
					if (gen8_rtl_var)
						...
						if (gen9_rtl_var)
							begin
							gen213_cyclix_var = 32'd1;
							gen364_pipex_mcopipe_rdata = genmcopipe_data_mem_resp_genfifo_buf_rdata;
							genmcopipe_data_mem_resp_genfifo_buf_req = 32'd0;
							genmcopipe_data_mem_resp_genfifo_buf_ack = 32'd1;
							end
						end
					gen214_cyclix_var = gen213_cyclix_var;
					gen10_rtl_var = gen214_cyclix_var;
					if (gen10_rtl_var)
						begin
						...
						genpstage_MEMWB_TRX_BUF[0].genmcopipe_handle_data_mem.rdata = gen364_pipex_mcopipe_rdata;
		...
		gen11_rtl_var = gen215_cyclix_var;
		if (gen11_rtl_var)
			begin
			genpstage_MEMWB_genctrl_active = 32'd0;
			end
	...
	gen12_rtl_var = gen216_cyclix_var;
	if (gen12_rtl_var)
		begin
		case (genpstage_MEMWB_TRX_LOCAL.funct3)
			32'd0:
				...
				gen13_rtl_var = gen217_cyclix_var;
				if (gen13_rtl_var)
					begin
			...
			32'd1:
				...
				gen14_rtl_var = gen218_cyclix_var;
				if (gen14_rtl_var)
					begin
					genpstage_MEMWB_TRX_LOCAL.jump_req = 32'd1;
					genpstage_MEMWB_TRX_LOCAL.jump_vector = genpstage_MEMWB_TRX_LOCAL.curinstraddr_imm;
			...
			32'd4:
				...
				gen15_rtl_var = gen219_cyclix_var;
				if (gen15_rtl_var)
					begin
					genpstage_MEMWB_TRX_LOCAL.jump_req = 32'd1;
					genpstage_MEMWB_TRX_LOCAL.jump_vector = genpstage_MEMWB_TRX_LOCAL.curinstraddr_imm;
			...
			32'd5:
				...
				gen16_rtl_var = gen220_cyclix_var;
				if (gen16_rtl_var)
					begin
					genpstage_MEMWB_TRX_LOCAL.jump_req = 32'd1;
					genpstage_MEMWB_TRX_LOCAL.jump_vector = genpstage_MEMWB_TRX_LOCAL.curinstraddr_imm;
			...
			32'd6:
				...
				gen17_rtl_var = gen221_cyclix_var;
				if (gen17_rtl_var)
					begin
					genpstage_MEMWB_TRX_LOCAL.jump_req = 32'd1;
					genpstage_MEMWB_TRX_LOCAL.jump_vector = genpstage_MEMWB_TRX_LOCAL.curinstraddr_imm;
			...
			32'd7:
				...
				gen18_rtl_var = gen222_cyclix_var;
				if (gen18_rtl_var)
					begin
					genpstage_MEMWB_TRX_LOCAL.jump_req = 32'd1;
					genpstage_MEMWB_TRX_LOCAL.jump_vector = genpstage_MEMWB_TRX_LOCAL.curinstraddr_imm;
	...
	if (gen19_rtl_var)
		...
		gen22_rtl_var = gen226_cyclix_var;
		if (gen22_rtl_var)
			begin
	...
	gen23_rtl_var = gen227_cyclix_var;
	if (gen23_rtl_var)
		begin
		...
		gen24_rtl_var = gen228_cyclix_var;
		if (gen24_rtl_var)
			begin
			...
			gen25_rtl_var = gen229_cyclix_var;
			if (gen25_rtl_var)
				begin
				gen230_cyclix_var = ~genmcopipe_data_mem_full_flag;
				gen231_cyclix_var = gen230_cyclix_var;
				gen26_rtl_var = gen231_cyclix_var;
				if (gen26_rtl_var)
					begin
					gen365_pipex_req_struct.we = genpstage_MEMWB_TRX_LOCAL.mem_cmd;
					gen365_pipex_req_struct.wdata = genpstage_MEMWB_TRX_LOCAL.data_busreq;
					gen27_rtl_var = !rst_i;
					gen28_rtl_var = gen27_rtl_var;
					if (gen28_rtl_var)
						begin
						genmcopipe_data_mem_req_genfifo_req_o = 32'd1;
						gen29_rtl_var = genmcopipe_data_mem_req_genfifo_reqbuf_req;
						if (gen29_rtl_var)
							begin
							gen232_cyclix_var = 32'd0;
							end
						...
						if (gen30_rtl_var)
							begin
							genmcopipe_data_mem_req_genfifo_wdata_bo = gen365_pipex_req_struct;
							gen232_cyclix_var = genmcopipe_data_mem_req_genfifo_ack_i;
							end
						genmcopipe_data_mem_req_genfifo_reqbuf_req = 32'd1;
						end
					gen233_cyclix_var = gen232_cyclix_var;
					gen31_rtl_var = gen233_cyclix_var;
					if (gen31_rtl_var)
						begin
						gen335_pipex_var = 32'd1;
						gen234_cyclix_var = !genpstage_MEMWB_TRX_LOCAL.mem_cmd;
						genpstage_MEMWB_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending = gen234_cyclix_var;
						...
						gen32_rtl_var = gen235_cyclix_var;
						if (gen32_rtl_var)
							begin
			...
			genpstage_MEMWB_TRX_LOCAL.data_req_done = gen335_pipex_var;
			gen236_cyclix_var = genpstage_MEMWB_genctrl_active;
			gen33_rtl_var = gen236_cyclix_var;
			if (gen33_rtl_var)
				begin
				genpstage_MEMWB_TRX_BUF[0].data_req_done = gen335_pipex_var;
				end
			end
		...
		gen34_rtl_var = gen237_cyclix_var;
		if (gen34_rtl_var)
			begin
			gen238_cyclix_var = genpstage_MEMWB_genctrl_active;
			gen35_rtl_var = gen238_cyclix_var;
			if (gen35_rtl_var)
				begin
	...
	gen344_pipex_var = (genpstage_MEMWB_TRX_LOCAL.mem_be == 32'd1);
	gen345_pipex_var = gen344_pipex_var;
	gen245_cyclix_var = gen345_pipex_var;
	gen42_rtl_var = gen245_cyclix_var;
	if (gen42_rtl_var)
		begin
		gen346_pipex_var = genpstage_MEMWB_TRX_LOCAL.load_signext;
		gen246_cyclix_var = gen346_pipex_var;
		gen43_rtl_var = gen246_cyclix_var;
		if (gen43_rtl_var)
			begin
			gen347_pipex_var = genpstage_MEMWB_TRX_LOCAL.mem_rdata[7:0];
			gen348_pipex_var = gen347_pipex_var[32'd7];
			gen349_pipex_var = {gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, gen348_pipex_var, genpstage_MEMWB_TRX_LOCAL.mem_rdata[7:0]};
			genpstage_MEMWB_TRX_LOCAL.mem_rdata = gen349_pipex_var;
			end
		gen350_pipex_var = 1'd0;
		gen350_pipex_var = (gen350_pipex_var || gen346_pipex_var);
		gen350_pipex_var = !gen350_pipex_var;
		gen247_cyclix_var = gen350_pipex_var;
		gen44_rtl_var = gen247_cyclix_var;
		if (gen44_rtl_var)
			begin
			gen351_pipex_var = {24'd0, genpstage_MEMWB_TRX_LOCAL.mem_rdata[7:0]};
			genpstage_MEMWB_TRX_LOCAL.mem_rdata = gen351_pipex_var;
			end
		end
	gen352_pipex_var = (genpstage_MEMWB_TRX_LOCAL.mem_be == 32'd3);
	gen353_pipex_var = gen352_pipex_var;
	gen248_cyclix_var = gen353_pipex_var;
	gen45_rtl_var = gen248_cyclix_var;
	if (gen45_rtl_var)
		begin
		gen354_pipex_var = genpstage_MEMWB_TRX_LOCAL.load_signext;
		gen249_cyclix_var = gen354_pipex_var;
		gen46_rtl_var = gen249_cyclix_var;
		if (gen46_rtl_var)
			begin
			gen355_pipex_var = genpstage_MEMWB_TRX_LOCAL.mem_rdata[15:0];
			gen356_pipex_var = gen355_pipex_var[32'd15];
			gen357_pipex_var = {gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, gen356_pipex_var, genpstage_MEMWB_TRX_LOCAL.mem_rdata[15:0]};
			genpstage_MEMWB_TRX_LOCAL.mem_rdata = gen357_pipex_var;
			end
		...
		gen47_rtl_var = gen250_cyclix_var;
		if (gen47_rtl_var)
			begin
			gen359_pipex_var = {16'd0, genpstage_MEMWB_TRX_LOCAL.mem_rdata[15:0]};
			genpstage_MEMWB_TRX_LOCAL.mem_rdata = gen359_pipex_var;
			end
		end
	gen360_pipex_var = (genpstage_MEMWB_TRX_LOCAL.rd_source == 32'd5);
	gen361_pipex_var = gen360_pipex_var;
	gen251_cyclix_var = gen361_pipex_var;
	gen48_rtl_var = gen251_cyclix_var;
	if (gen48_rtl_var)
		begin
	...
	gen49_rtl_var = gen252_cyclix_var;
	if (gen49_rtl_var)
		begin
	...
	gen54_rtl_var = gen258_cyclix_var;
	if (gen54_rtl_var)
		begin
		genpstage_EXEC_genctrl_new = 32'd0;
		genpstage_EXEC_genctrl_stalled_glbl = 32'd0;
	...
	gen56_rtl_var = gen260_cyclix_var;
	if (gen56_rtl_var)
		begin
		// Initializing new newaccums descriptors ####
		gen261_cyclix_var = genpstage_EXEC_genctrl_new;
		gen57_rtl_var = gen261_cyclix_var;
		if (gen57_rtl_var)
			begin
		...
		gen58_rtl_var = gen262_cyclix_var;
		if (gen58_rtl_var)
			begin
			genpstage_EXEC_genctrl_active = 32'd0;
			end
	...
	gen59_rtl_var = gen263_cyclix_var;
	if (gen59_rtl_var)
		begin
		genpstage_EXEC_genctrl_active = 32'd0;
		end
	...
	if (gen60_rtl_var)
		...
		if (gen61_rtl_var)
			...
			genpstage_EXEC_TRX_LOCAL.irq_recv = gen289_pipex_var;
			gen268_cyclix_var = genpstage_EXEC_genctrl_active;
			gen66_rtl_var = gen268_cyclix_var;
			if (gen66_rtl_var)
				begin
			...
			gen67_rtl_var = gen269_cyclix_var;
			if (gen67_rtl_var)
				begin
		...
		gen68_rtl_var = gen270_cyclix_var;
		if (gen68_rtl_var)
			begin
	...
	gen72_rtl_var = gen274_cyclix_var;
	if (gen72_rtl_var)
		begin
		gen275_cyclix_var = genpstage_EXEC_genctrl_active;
		gen73_rtl_var = gen275_cyclix_var;
		if (gen73_rtl_var)
			begin
			genpsticky_glbl_MIRQEN = 32'd1;
			end
	...
	gen74_rtl_var = gen276_cyclix_var;
	if (gen74_rtl_var)
		begin
		case (genpstage_EXEC_TRX_LOCAL.alu_opcode)
			32'd0:
				...
				genpstage_EXEC_TRX_LOCAL.alu_result_wide = gen293_pipex_var;
				end
			32'd1:
				begin
				gen294_pipex_var = (genpstage_EXEC_TRX_LOCAL.alu_op1_wide - genpstage_EXEC_TRX_LOCAL.alu_op2_wide);
				genpstage_EXEC_TRX_LOCAL.alu_result_wide = gen294_pipex_var;
				end
			32'd2:
				begin
				gen295_pipex_var = (genpstage_EXEC_TRX_LOCAL.alu_op1_wide & genpstage_EXEC_TRX_LOCAL.alu_op2_wide);
				genpstage_EXEC_TRX_LOCAL.alu_result_wide = gen295_pipex_var;
				end
			32'd3:
				begin
				gen296_pipex_var = (genpstage_EXEC_TRX_LOCAL.alu_op1_wide | genpstage_EXEC_TRX_LOCAL.alu_op2_wide);
				genpstage_EXEC_TRX_LOCAL.alu_result_wide = gen296_pipex_var;
				end
			32'd4:
				begin
				gen297_pipex_var = (genpstage_EXEC_TRX_LOCAL.alu_op1_wide << genpstage_EXEC_TRX_LOCAL.alu_op2_wide);
				genpstage_EXEC_TRX_LOCAL.alu_result_wide = gen297_pipex_var;
				end
			32'd5:
				begin
				gen298_pipex_var = {32'd0, genpstage_EXEC_TRX_LOCAL.alu_op1_wide[31:0]};
				gen299_pipex_var = (gen298_pipex_var >> genpstage_EXEC_TRX_LOCAL.alu_op2_wide[4:0]);
				genpstage_EXEC_TRX_LOCAL.alu_result_wide = gen299_pipex_var;
				end
			32'd6:
				begin
				gen300_pipex_var = genpstage_EXEC_TRX_LOCAL.alu_op1_wide[31:0];
				gen301_pipex_var = gen300_pipex_var[32'd31];
				gen302_pipex_var = {gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, gen301_pipex_var, genpstage_EXEC_TRX_LOCAL.alu_op1_wide[31:0]};
				gen303_pipex_var = (gen302_pipex_var >>> genpstage_EXEC_TRX_LOCAL.alu_op2_wide[4:0]);
				genpstage_EXEC_TRX_LOCAL.alu_result_wide = gen303_pipex_var;
				end
			32'd7:
				begin
				gen304_pipex_var = (genpstage_EXEC_TRX_LOCAL.alu_op1_wide ^ genpstage_EXEC_TRX_LOCAL.alu_op2_wide);
				genpstage_EXEC_TRX_LOCAL.alu_result_wide = gen304_pipex_var;
				end
			32'd8:
				begin
				...
				genpstage_EXEC_TRX_LOCAL.alu_result_wide = gen306_pipex_var;
				end
		endcase
		...
		genpstage_EXEC_TRX_LOCAL.alu_ZF = gen308_pipex_var;
		...
		gen76_rtl_var = gen278_cyclix_var;
		if (gen76_rtl_var)
			begin
	...
	gen81_rtl_var = gen284_cyclix_var;
	if (gen81_rtl_var)
		begin
		// programming next stage in case transaction is able to propagate
		gen285_cyclix_var = genpstage_EXEC_genctrl_succ;
		gen82_rtl_var = gen285_cyclix_var;
		if (gen82_rtl_var)
			begin
			gen286_cyclix_var = genpstage_MEMWB_genctrl_rdy;
			gen83_rtl_var = gen286_cyclix_var;
			if (gen83_rtl_var)
				begin
	...
	gen84_rtl_var = gen288_cyclix_var;
	if (gen84_rtl_var)
		begin
		genpstage_IDECODE_genctrl_new = 32'd0;
		genpstage_IDECODE_genctrl_stalled_glbl = 32'd0;
	...
	gen86_rtl_var = gen290_cyclix_var;
	if (gen86_rtl_var)
		begin
		// Initializing new newaccums descriptors ####
		gen291_cyclix_var = genpstage_IDECODE_genctrl_new;
		gen87_rtl_var = gen291_cyclix_var;
		if (gen87_rtl_var)
			begin
		...
		gen88_rtl_var = gen292_cyclix_var;
		if (gen88_rtl_var)
			begin
			gen293_cyclix_var = (genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.if_id == 1'd0);
			gen294_cyclix_var = gen293_cyclix_var;
			gen89_rtl_var = gen294_cyclix_var;
			if (gen89_rtl_var)
				begin
				...
				gen90_rtl_var = gen296_cyclix_var;
				if (gen90_rtl_var)
					begin
					gen91_rtl_var = !rst_i;
					...
					if (gen92_rtl_var)
						...
						if (gen93_rtl_var)
							begin
							gen297_cyclix_var = 32'd1;
							gen366_pipex_mcopipe_rdata = genmcopipe_instr_mem_resp_genfifo_buf_rdata;
							genmcopipe_instr_mem_resp_genfifo_buf_req = 32'd0;
							genmcopipe_instr_mem_resp_genfifo_buf_ack = 32'd1;
							end
						end
					gen298_cyclix_var = gen297_cyclix_var;
					gen94_rtl_var = gen298_cyclix_var;
					if (gen94_rtl_var)
						begin
						...
						genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.rdata = gen366_pipex_mcopipe_rdata;
		...
		gen95_rtl_var = gen299_cyclix_var;
		if (gen95_rtl_var)
			begin
			genpstage_IDECODE_genctrl_active = 32'd0;
			end
	...
	gen98_rtl_var = gen302_cyclix_var;
	if (gen98_rtl_var)
		begin
		gen303_cyclix_var = genpstage_IDECODE_genctrl_active;
		gen99_rtl_var = gen303_cyclix_var;
		if (gen99_rtl_var)
			begin
	...
	gen196_pipex_var = gen195_pipex_var[32'd31];
	gen197_pipex_var = {gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, gen196_pipex_var, genpstage_IDECODE_TRX_LOCAL.instr_code[31:20]};
	genpstage_IDECODE_TRX_LOCAL.immediate_I = gen197_pipex_var;
	gen198_pipex_var = {genpstage_IDECODE_TRX_LOCAL.instr_code[31:25], genpstage_IDECODE_TRX_LOCAL.instr_code[11:7]};
	gen199_pipex_var = gen198_pipex_var[32'd11];
	...
	genpstage_IDECODE_TRX_LOCAL.immediate_S = gen200_pipex_var;
	gen201_pipex_var = {genpstage_IDECODE_TRX_LOCAL.instr_code[31], genpstage_IDECODE_TRX_LOCAL.instr_code[7], genpstage_IDECODE_TRX_LOCAL.instr_code[30:25], genpstage_IDECODE_TRX_LOCAL.instr_code[11:8], 1'd0};
	gen202_pipex_var = gen201_pipex_var[32'd12];
	gen203_pipex_var = {gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen202_pipex_var, gen201_pipex_var};
	genpstage_IDECODE_TRX_LOCAL.immediate_B = gen203_pipex_var;
	gen204_pipex_var = {genpstage_IDECODE_TRX_LOCAL.instr_code[31:12], 12'd0};
	genpstage_IDECODE_TRX_LOCAL.immediate_U = gen204_pipex_var;
	gen205_pipex_var = {genpstage_IDECODE_TRX_LOCAL.instr_code[31], genpstage_IDECODE_TRX_LOCAL.instr_code[19:12], genpstage_IDECODE_TRX_LOCAL.instr_code[20], genpstage_IDECODE_TRX_LOCAL.instr_code[30:21], 1'd0};
	gen206_pipex_var = gen205_pipex_var[32'd20];
	gen207_pipex_var = {gen206_pipex_var, gen206_pipex_var, gen206_pipex_var, gen206_pipex_var, gen206_pipex_var, gen206_pipex_var, gen206_pipex_var, gen206_pipex_var, gen206_pipex_var, gen206_pipex_var, gen206_pipex_var, gen205_pipex_var};
	genpstage_IDECODE_TRX_LOCAL.immediate_J = gen207_pipex_var;
	case (genpstage_IDECODE_TRX_LOCAL.opcode)
		...
		32'd99:
			...
			gen208_pipex_var = (genpstage_IDECODE_TRX_LOCAL.funct3 == 32'd6);
			gen209_pipex_var = (genpstage_IDECODE_TRX_LOCAL.funct3 == 32'd7);
			gen210_pipex_var = (gen208_pipex_var | gen209_pipex_var);
			gen211_pipex_var = gen210_pipex_var;
			gen304_cyclix_var = gen211_pipex_var;
			gen100_rtl_var = gen304_cyclix_var;
			if (gen100_rtl_var)
				begin
		...
		32'd19:
			...
			case (genpstage_IDECODE_TRX_LOCAL.funct3)
				...
				32'd1:
					...
					genpstage_IDECODE_TRX_LOCAL.rd_source = 32'd1;
					gen212_pipex_var = {27'd0, genpstage_IDECODE_TRX_LOCAL.instr_code[24:20]};
					genpstage_IDECODE_TRX_LOCAL.immediate = gen212_pipex_var;
					end
				32'd2:
					begin
					genpstage_IDECODE_TRX_LOCAL.alu_opcode = 32'd1;
				...
				32'd5:
					...
					gen101_rtl_var = gen305_cyclix_var;
					if (gen101_rtl_var)
						begin
						genpstage_IDECODE_TRX_LOCAL.alu_opcode = 32'd6;
						end
					gen214_pipex_var = 1'd0;
					gen214_pipex_var = (gen214_pipex_var || gen213_pipex_var);
					gen214_pipex_var = !gen214_pipex_var;
					gen306_cyclix_var = gen214_pipex_var;
					gen102_rtl_var = gen306_cyclix_var;
					if (gen102_rtl_var)
						begin
						genpstage_IDECODE_TRX_LOCAL.alu_opcode = 32'd5;
						end
					genpstage_IDECODE_TRX_LOCAL.rd_source = 32'd1;
					gen215_pipex_var = {27'd0, genpstage_IDECODE_TRX_LOCAL.instr_code[24:20]};
					genpstage_IDECODE_TRX_LOCAL.immediate = gen215_pipex_var;
					end
				32'd6:
					begin
		...
		32'd115:
			...
			case (genpstage_IDECODE_TRX_LOCAL.funct3)
				...
				32'd5:
					...
					genpstage_IDECODE_TRX_LOCAL.op1_source = 32'd1;
					genpstage_IDECODE_TRX_LOCAL.op2_source = 32'd2;
					gen222_pipex_var = {27'd0, genpstage_IDECODE_TRX_LOCAL.zimm};
					genpstage_IDECODE_TRX_LOCAL.immediate = gen222_pipex_var;
					end
				32'd6:
					begin
					genpstage_IDECODE_TRX_LOCAL.csrreq = 32'd1;
					...
					genpstage_IDECODE_TRX_LOCAL.op1_source = 32'd1;
					genpstage_IDECODE_TRX_LOCAL.op2_source = 32'd2;
					gen223_pipex_var = {27'd0, genpstage_IDECODE_TRX_LOCAL.zimm};
					genpstage_IDECODE_TRX_LOCAL.immediate = gen223_pipex_var;
					end
				32'd7:
					begin
					genpstage_IDECODE_TRX_LOCAL.csrreq = 32'd1;
					...
					genpstage_IDECODE_TRX_LOCAL.op1_source = 32'd1;
					genpstage_IDECODE_TRX_LOCAL.op2_source = 32'd2;
					gen224_pipex_var = {27'd0, genpstage_IDECODE_TRX_LOCAL.zimm};
					genpstage_IDECODE_TRX_LOCAL.immediate = gen224_pipex_var;
					end
			endcase
			end
	endcase
	...
	gen109_rtl_var = gen313_cyclix_var;
	if (gen109_rtl_var)
		begin
		case (genpstage_IDECODE_TRX_LOCAL.funct3)
			32'd0:
	...
	gen226_pipex_var = (genpstage_IDECODE_TRX_LOCAL.instr_code == 32'd807403635);
	gen227_pipex_var = gen226_pipex_var;
	gen314_cyclix_var = gen227_pipex_var;
	gen110_rtl_var = gen314_cyclix_var;
	if (gen110_rtl_var)
		begin
	...
	gen228_pipex_var = (genpstage_IDECODE_TRX_LOCAL.rd_addr == 32'd0);
	gen229_pipex_var = gen228_pipex_var;
	gen315_cyclix_var = gen229_pipex_var;
	gen111_rtl_var = gen315_cyclix_var;
	if (gen111_rtl_var)
		begin
		genpstage_IDECODE_TRX_LOCAL.rd_req = 32'd0;
		end
	gen230_pipex_var[1] = gen316_cyclix_var[1];
	gen230_pipex_var[2] = gen316_cyclix_var[2];
	gen230_pipex_var[3] = gen316_cyclix_var[3];
	gen230_pipex_var[4] = gen316_cyclix_var[4];
	gen230_pipex_var[5] = gen316_cyclix_var[5];
	gen230_pipex_var[6] = gen316_cyclix_var[6];
	gen230_pipex_var[7] = gen316_cyclix_var[7];
	gen230_pipex_var[8] = gen316_cyclix_var[8];
	gen230_pipex_var[9] = gen316_cyclix_var[9];
	gen230_pipex_var[10] = gen316_cyclix_var[10];
	gen230_pipex_var[11] = gen316_cyclix_var[11];
	gen230_pipex_var[12] = gen316_cyclix_var[12];
	gen230_pipex_var[13] = gen316_cyclix_var[13];
	gen230_pipex_var[14] = gen316_cyclix_var[14];
	gen230_pipex_var[15] = gen316_cyclix_var[15];
	gen230_pipex_var[16] = gen316_cyclix_var[16];
	gen230_pipex_var[17] = gen316_cyclix_var[17];
	gen230_pipex_var[18] = gen316_cyclix_var[18];
	gen230_pipex_var[19] = gen316_cyclix_var[19];
	gen230_pipex_var[20] = gen316_cyclix_var[20];
	gen230_pipex_var[21] = gen316_cyclix_var[21];
	gen230_pipex_var[22] = gen316_cyclix_var[22];
	gen230_pipex_var[23] = gen316_cyclix_var[23];
	gen230_pipex_var[24] = gen316_cyclix_var[24];
	gen230_pipex_var[25] = gen316_cyclix_var[25];
	gen230_pipex_var[26] = gen316_cyclix_var[26];
	gen230_pipex_var[27] = gen316_cyclix_var[27];
	gen230_pipex_var[28] = gen316_cyclix_var[28];
	gen230_pipex_var[29] = gen316_cyclix_var[29];
	gen230_pipex_var[30] = gen316_cyclix_var[30];
	gen230_pipex_var[31] = gen316_cyclix_var[31];
	genpstage_IDECODE_TRX_LOCAL.rs1_rdata = gen230_pipex_var[genpstage_IDECODE_TRX_LOCAL.rs1_addr];
	gen231_pipex_var[1] = gen316_cyclix_var[1];
	gen231_pipex_var[2] = gen316_cyclix_var[2];
	gen231_pipex_var[3] = gen316_cyclix_var[3];
	gen231_pipex_var[4] = gen316_cyclix_var[4];
	gen231_pipex_var[5] = gen316_cyclix_var[5];
	gen231_pipex_var[6] = gen316_cyclix_var[6];
	gen231_pipex_var[7] = gen316_cyclix_var[7];
	gen231_pipex_var[8] = gen316_cyclix_var[8];
	gen231_pipex_var[9] = gen316_cyclix_var[9];
	gen231_pipex_var[10] = gen316_cyclix_var[10];
	gen231_pipex_var[11] = gen316_cyclix_var[11];
	gen231_pipex_var[12] = gen316_cyclix_var[12];
	gen231_pipex_var[13] = gen316_cyclix_var[13];
	gen231_pipex_var[14] = gen316_cyclix_var[14];
	gen231_pipex_var[15] = gen316_cyclix_var[15];
	gen231_pipex_var[16] = gen316_cyclix_var[16];
	gen231_pipex_var[17] = gen316_cyclix_var[17];
	gen231_pipex_var[18] = gen316_cyclix_var[18];
	gen231_pipex_var[19] = gen316_cyclix_var[19];
	gen231_pipex_var[20] = gen316_cyclix_var[20];
	gen231_pipex_var[21] = gen316_cyclix_var[21];
	gen231_pipex_var[22] = gen316_cyclix_var[22];
	gen231_pipex_var[23] = gen316_cyclix_var[23];
	gen231_pipex_var[24] = gen316_cyclix_var[24];
	gen231_pipex_var[25] = gen316_cyclix_var[25];
	gen231_pipex_var[26] = gen316_cyclix_var[26];
	gen231_pipex_var[27] = gen316_cyclix_var[27];
	gen231_pipex_var[28] = gen316_cyclix_var[28];
	gen231_pipex_var[29] = gen316_cyclix_var[29];
	gen231_pipex_var[30] = gen316_cyclix_var[30];
	gen231_pipex_var[31] = gen316_cyclix_var[31];
	genpstage_IDECODE_TRX_LOCAL.rs2_rdata = gen231_pipex_var[genpstage_IDECODE_TRX_LOCAL.rs2_addr];
	gen232_pipex_var = (genpstage_IDECODE_TRX_LOCAL.rs1_addr == 32'd0);
	gen233_pipex_var = gen232_pipex_var;
	gen317_cyclix_var = gen233_pipex_var;
	gen112_rtl_var = gen317_cyclix_var;
	if (gen112_rtl_var)
		begin
		genpstage_IDECODE_TRX_LOCAL.rs1_rdata = 32'd0;
		end
	gen234_pipex_var = (genpstage_IDECODE_TRX_LOCAL.rs2_addr == 32'd0);
	gen235_pipex_var = gen234_pipex_var;
	gen318_cyclix_var = gen235_pipex_var;
	gen113_rtl_var = gen318_cyclix_var;
	if (gen113_rtl_var)
		begin
	...
	gen114_rtl_var = gen319_cyclix_var;
	if (gen114_rtl_var)
		begin
	...
	if (gen115_rtl_var)
		...
		if (gen116_rtl_var)
			...
			if (gen117_rtl_var)
				...
				gen120_rtl_var = gen325_cyclix_var;
				if (gen120_rtl_var)
					begin
					gen326_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen121_rtl_var = gen326_cyclix_var;
					if (gen121_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
		...
		gen122_rtl_var = gen327_cyclix_var;
		if (gen122_rtl_var)
			begin
	...
	if (gen128_rtl_var)
		...
		if (gen129_rtl_var)
			...
			if (gen130_rtl_var)
				...
				if (gen131_rtl_var)
					...
					gen132_rtl_var = gen337_cyclix_var;
					if (gen132_rtl_var)
						begin
				...
				gen133_rtl_var = gen338_cyclix_var;
				if (gen133_rtl_var)
					begin
					gen339_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen134_rtl_var = gen339_cyclix_var;
					if (gen134_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
		...
		gen135_rtl_var = gen340_cyclix_var;
		if (gen135_rtl_var)
			begin
			...
			if (gen136_rtl_var)
				...
				if (gen137_rtl_var)
					...
					gen138_rtl_var = gen343_cyclix_var;
					if (gen138_rtl_var)
						begin
				...
				gen139_rtl_var = gen344_cyclix_var;
				if (gen139_rtl_var)
					begin
					gen345_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen140_rtl_var = gen345_cyclix_var;
					if (gen140_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
	...
	gen141_rtl_var = gen346_cyclix_var;
	if (gen141_rtl_var)
		begin
		gen278_pipex_var = {1'd0, genpstage_IDECODE_TRX_LOCAL.alu_op1};
		genpstage_IDECODE_TRX_LOCAL.alu_op1_wide = gen278_pipex_var;
		gen279_pipex_var = {1'd0, genpstage_IDECODE_TRX_LOCAL.alu_op2};
		genpstage_IDECODE_TRX_LOCAL.alu_op2_wide = gen279_pipex_var;
		end
	gen280_pipex_var = 1'd0;
	gen280_pipex_var = (gen280_pipex_var || gen277_pipex_var);
	gen280_pipex_var = !gen280_pipex_var;
	gen347_cyclix_var = gen280_pipex_var;
	gen142_rtl_var = gen347_cyclix_var;
	if (gen142_rtl_var)
		begin
		gen281_pipex_var = genpstage_IDECODE_TRX_LOCAL.alu_op1[32'd31];
		gen282_pipex_var = {gen281_pipex_var, genpstage_IDECODE_TRX_LOCAL.alu_op1};
		genpstage_IDECODE_TRX_LOCAL.alu_op1_wide = gen282_pipex_var;
		gen283_pipex_var = genpstage_IDECODE_TRX_LOCAL.alu_op2[32'd31];
		gen284_pipex_var = {gen283_pipex_var, genpstage_IDECODE_TRX_LOCAL.alu_op2};
		genpstage_IDECODE_TRX_LOCAL.alu_op2_wide = gen284_pipex_var;
		end
	// Processing of next pstage busyness
	gen348_cyclix_var = ~genpstage_EXEC_genctrl_rdy;
	gen349_cyclix_var = gen348_cyclix_var;
	gen143_rtl_var = gen349_cyclix_var;
	if (gen143_rtl_var)
		begin
		gen350_cyclix_var = genpstage_IDECODE_genctrl_active;
		gen144_rtl_var = gen350_cyclix_var;
		if (gen144_rtl_var)
			begin
			genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
			end
	...
	gen145_rtl_var = gen351_cyclix_var;
	if (gen145_rtl_var)
		begin
		genpstage_IDECODE_genctrl_finish = 32'd0;
		genpstage_IDECODE_genctrl_succ = 32'd0;
	...
	gen146_rtl_var = gen352_cyclix_var;
	if (gen146_rtl_var)
		begin
	...
	gen147_rtl_var = gen353_cyclix_var;
	if (gen147_rtl_var)
		begin
		// programming next stage in case transaction is able to propagate
		gen354_cyclix_var = genpstage_IDECODE_genctrl_succ;
		gen148_rtl_var = gen354_cyclix_var;
		if (gen148_rtl_var)
			begin
			gen355_cyclix_var = genpstage_EXEC_genctrl_rdy;
			gen149_rtl_var = gen355_cyclix_var;
			if (gen149_rtl_var)
				begin
				// propagating transaction context
	...
	gen150_rtl_var = gen357_cyclix_var;
	if (gen150_rtl_var)
		begin
		genpstage_IFETCH_genctrl_new = 32'd0;
		genpstage_IFETCH_genctrl_stalled_glbl = 32'd0;
	...
	gen152_rtl_var = gen359_cyclix_var;
	if (gen152_rtl_var)
		begin
		// Initializing new newaccums descriptors ####
		gen360_cyclix_var = genpstage_IFETCH_genctrl_new;
		gen153_rtl_var = gen360_cyclix_var;
		if (gen153_rtl_var)
			begin
		...
		gen154_rtl_var = gen361_cyclix_var;
		if (gen154_rtl_var)
			begin
			gen362_cyclix_var = (genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.if_id == 1'd0);
			gen363_cyclix_var = gen362_cyclix_var;
			gen155_rtl_var = gen363_cyclix_var;
			if (gen155_rtl_var)
				begin
				...
				gen156_rtl_var = gen365_cyclix_var;
				if (gen156_rtl_var)
					begin
					gen157_rtl_var = !rst_i;
					gen158_rtl_var = gen157_rtl_var;
					if (gen158_rtl_var)
						begin
						gen366_cyclix_var = 32'd0;
						gen159_rtl_var = genmcopipe_instr_mem_resp_genfifo_buf_req;
						if (gen159_rtl_var)
							begin
							gen366_cyclix_var = 32'd1;
							gen367_pipex_mcopipe_rdata = genmcopipe_instr_mem_resp_genfifo_buf_rdata;
							genmcopipe_instr_mem_resp_genfifo_buf_req = 32'd0;
							genmcopipe_instr_mem_resp_genfifo_buf_ack = 32'd1;
							end
						end
					gen367_cyclix_var = gen366_cyclix_var;
					gen160_rtl_var = gen367_cyclix_var;
					if (gen160_rtl_var)
						begin
						...
						genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdata = gen367_pipex_mcopipe_rdata;
						genmcopipe_instr_mem_rd_done = 32'd1;
						end
					end
				end
		...
		gen161_rtl_var = gen368_cyclix_var;
		if (gen161_rtl_var)
			begin
			end
		end
	...
	gen184_pipex_var = (genpstage_IFETCH_TRX_LOCAL.curinstr_addr + 32'd4);
	genpstage_IFETCH_TRX_LOCAL.nextinstr_addr = gen184_pipex_var;
	gen181_pipex_succreq = 32'd1;
	...
	gen167_rtl_var = gen374_cyclix_var;
	if (gen167_rtl_var)
		begin
		gen375_cyclix_var = genpstage_IFETCH_genctrl_active;
		gen168_rtl_var = gen375_cyclix_var;
		if (gen168_rtl_var)
			begin
			gen376_cyclix_var = ~genmcopipe_instr_mem_full_flag;
			gen377_cyclix_var = gen376_cyclix_var;
			gen169_rtl_var = gen377_cyclix_var;
			if (gen169_rtl_var)
				begin
				gen368_pipex_req_struct.we = 1'd0;
				gen368_pipex_req_struct.wdata = genpstage_IFETCH_TRX_LOCAL.instr_busreq;
				gen170_rtl_var = !rst_i;
				gen171_rtl_var = gen170_rtl_var;
				if (gen171_rtl_var)
					begin
					genmcopipe_instr_mem_req_genfifo_req_o = 32'd1;
					gen172_rtl_var = genmcopipe_instr_mem_req_genfifo_reqbuf_req;
					if (gen172_rtl_var)
						begin
						gen378_cyclix_var = 32'd0;
						end
					gen173_rtl_var = 1'd0;
					gen173_rtl_var = (gen173_rtl_var || gen172_rtl_var);
					gen173_rtl_var = !gen173_rtl_var;
					if (gen173_rtl_var)
						begin
						genmcopipe_instr_mem_req_genfifo_wdata_bo = gen368_pipex_req_struct;
						gen378_cyclix_var = genmcopipe_instr_mem_req_genfifo_ack_i;
						end
					genmcopipe_instr_mem_req_genfifo_reqbuf_req = 32'd1;
					end
				gen379_cyclix_var = gen378_cyclix_var;
				gen174_rtl_var = gen379_cyclix_var;
				if (gen174_rtl_var)
					begin
					gen188_pipex_var = 32'd1;
					gen380_cyclix_var = !1'd0;
					genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending = gen380_cyclix_var;
					...
					gen175_rtl_var = gen381_cyclix_var;
					if (gen175_rtl_var)
						begin
		...
		genpstage_IFETCH_TRX_LOCAL.instr_req_done = gen188_pipex_var;
		gen382_cyclix_var = genpstage_IFETCH_genctrl_active;
		gen176_rtl_var = gen382_cyclix_var;
		if (gen176_rtl_var)
			begin
			genpstage_IFETCH_TRX_BUF[0].instr_req_done = gen188_pipex_var;
			end
		end
	...
	gen177_rtl_var = gen383_cyclix_var;
	if (gen177_rtl_var)
		begin
		gen384_cyclix_var = genpstage_IFETCH_genctrl_active;
		gen178_rtl_var = gen384_cyclix_var;
		if (gen178_rtl_var)
			begin
	...
	gen179_rtl_var = gen386_cyclix_var;
	if (gen179_rtl_var)
		begin
		gen387_cyclix_var = genpstage_IFETCH_genctrl_active;
		gen180_rtl_var = gen387_cyclix_var;
		if (gen180_rtl_var)
			begin
			genpstage_IFETCH_genctrl_stalled_glbl = 32'd1;
			end
	...
	gen183_rtl_var = gen390_cyclix_var;
	if (gen183_rtl_var)
		begin
		gen391_cyclix_var = gen181_pipex_succreq;
		gen184_rtl_var = gen391_cyclix_var;
		if (gen184_rtl_var)
			begin
	...
	gen185_rtl_var = gen392_cyclix_var;
	if (gen185_rtl_var)
		begin
		// programming next stage in case transaction is able to propagate
		gen393_cyclix_var = genpstage_IFETCH_genctrl_succ;
		gen186_rtl_var = gen393_cyclix_var;
		if (gen186_rtl_var)
			begin
			gen394_cyclix_var = genpstage_IDECODE_genctrl_rdy;
			gen187_rtl_var = gen394_cyclix_var;
			if (gen187_rtl_var)
				begin
				// propagating transaction context
	...
	gen188_rtl_var = gen396_cyclix_var;
	if (gen188_rtl_var)
		begin
		...
		gen189_rtl_var = gen398_cyclix_var;
		if (gen189_rtl_var)
			begin
			genmcopipe_instr_mem_empty_flag = 32'd1;
			end
	...
	gen190_rtl_var = gen399_cyclix_var;
	if (gen190_rtl_var)
		begin
		...
		gen191_rtl_var = gen401_cyclix_var;
		if (gen191_rtl_var)
			begin
	...
	gen192_rtl_var = gen402_cyclix_var;
	if (gen192_rtl_var)
		begin
		...
		gen193_rtl_var = gen404_cyclix_var;
		if (gen193_rtl_var)
			begin
			genmcopipe_data_mem_empty_flag = 32'd1;
			end
	...
	gen194_rtl_var = gen405_cyclix_var;
	if (gen194_rtl_var)
		begin
		...
		gen195_rtl_var = gen407_cyclix_var;
		if (gen195_rtl_var)
			begin
